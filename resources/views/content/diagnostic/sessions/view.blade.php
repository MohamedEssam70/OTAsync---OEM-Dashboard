...
<script>
  $(function () {
      ...
      function updateData(isActive, frames, sensors, confirmed_count, confirmed, pending, logs)
      {
      ...
      {  
          $.ajax({
            ...
            success: function(data) {
              updateData(data.isActive, data.frames, data.sensors, data.confirmed_count, data.confirmed, data.pending,  data.logs)
            },
