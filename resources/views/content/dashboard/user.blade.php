@extends('layouts/contentNavbarLayout',['navbarBreadcrumbPrev' => 'Settings /', 'navbarBreadcrumbActive' => 'Account'])
...
<div class="row">
  <div class="col-md-12">
    <ul class="nav nav-pills flex-column flex-md-row mb-3">
      <li class="nav-item"><a class="nav-link active" href="javascript:void(0);"><i class="bx bx-user me-1"></i> My Profile</a></li>
          ...
          <div class="row">
            ...
            <div class="mb-3 col-md-6">
              ...
              <div class="input-group input-group-merge">
                <span class="input-group-text">EGYPT (+20)</span>
